...
import Logo from "@/assets/logoipsum-385.svg"
      ...
      <nav className="h-full flex flex-col bg-white">
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <button
            ...
            className="p-1 rounded-xs bg-gray-50 hover:bg-gray-100"
          >
...
export function SidebarItem({ icon, text, active, alert }: SidebarItemProps) {
  ...
  return (
    <li
      className={`
        relative flex items-center py-1.5 px-2 my-2
        font-medium rounded-xs cursor-pointer
